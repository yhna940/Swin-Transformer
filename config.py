...
_C.MODEL.WRAP.CHUNCKS = 1
_C.MODEL.WRAP.SHARDING_STRATEGY = None
_C.MODEL.WRAP.BACKWARD_PREFETCH = None
_C.MODEL.WRAP.MIN_NUM_WRAP_PARAMS = None
_C.MODEL.WRAP.OFFLOAD_PARAMS = False
_C.MODEL.WRAP.MIXED_PRECISION = False
